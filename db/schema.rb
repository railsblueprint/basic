...
ActiveRecord::Schema[8.0].define(version: 2025_08_04_154638) do
  ...
  create_table "mail_templates", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "alias"
    t.string "subject"
    t.string "body"
    t.string "layout"
    t.boolean "not_migrated", default: false, null: false
    t.datetime "deleted_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "locale", default: "en", null: false
    t.index ["alias", "locale"], name: "index_mail_templates_on_alias_and_locale", unique: true
  end

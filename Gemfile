...
gem "newrelic_rpm"
gem "nokogiri", "~> 1.19"
# json 3 dropped the positional options hash that ActiveSupport::JSON.decode still passes
# (wrong number of arguments, given 2, expected 1) on Rails 8.1.3.1; stay on 2.x until
# a Rails release calls JSON.parse with keywords.
gem "json", "~> 2.21"
gem "pagy", "~> 5.10"
gem "pg_search", "~> 2.3"
gem "premailer-rails"
...
group :development do
  ...
  gem "mina-puma-systemd", "~> 1.2.0", require: false
